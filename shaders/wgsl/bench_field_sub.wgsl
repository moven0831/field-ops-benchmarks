// ============================================================================
// Benchmark: BN254 Field Subtraction
// ============================================================================
// Tests modular subtraction for BN254 base field.
...
// BigInt256 addition with BN254_P
fn bigint_add_p(a: array<u32, 16>) -> array<u32, 16> {
    var result: array<u32, 16>;
    var carry: u32 = 0u;
...
fn field_sub(a: array<u32, 16>, b: array<u32, 16>) -> array<u32, 16> {
    ...
    if (diff[16] != 0u) {
        return bigint_add_p(result);
    }
    return result;
}

@compute @workgroup_size(64)
fn bench_field_sub(@builtin(global_invocation_id) global_id: vec3<u32>) {
    let tid = global_id.x;
